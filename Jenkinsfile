    ...
    stage('Delete all the things') {
      steps {
        ...
        sh '''
            ...
            curl --verbose -u admin:admin123 -X DELETE "http://http://ec2-54-165-203-133.compute-1.amazonaws.com:8081/service/rest/v1/tags/build-123" -H "accept: application/json"
        '''
      }
    }
  }
